...
alias gsh='gitsh'
alias his='history -i'
alias iftop='sudo iftop -BNPo 2s'
alias inspect-video='ffprobe -print_format json -show_format -show_streams -v quiet'
alias iotop='sudo iotop -t 10 2 2> /dev/null'
alias jsonlint='jsonlint -q'
alias lf='ls -rt | tail -n1'
alias ll='ls -alrth'
alias ls='ls -GFh'
alias lsgroups="cut -f1 -d: /etc/group"
alias lsof='sudo lsof'
alias mann='man2'
alias mask='ifconfig en0 | awk '\''/mask/{print $4}'\'
alias mcc='mc -c'
alias mcv='vim `mc`'
alias mkdir="mkdir -p"
...
alias top='top -u'
alias treedir="tree -aI 'bower|node_modules|.git' --matchdirs -d"
alias trn='tr -d [:space:]'
alias tt='tasktoday'
alias vimrc='vim `rc`'
alias wget='wget -q'
...
# ldd and strace are not available on OSX
